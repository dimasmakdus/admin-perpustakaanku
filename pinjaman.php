...
<head>
  ...
  <title>Perpustakaan Mahasiswa | Data Peminjaman</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pinjaman.php" class="nav-link active">
              ...
              <div class="card-body">                      
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= $pinjam["terlambat"]; ?></td>
                    <td><?= $pinjam["status"]; ?></td>
                    <td>
                      <a href="datakembali.php?id=<?= $pinjam["id"]; ?>" class="btn btn-xs btn-default">
                      <i class="nav-icon fas fa-sync-alt"></i> Kembali</a>                    
                      <a href="" class="btn btn-xs btn-success">
                      <i class="nav-icon fas fa-pen"></i> Perpanjang</a>
                    </td>
                  </tr>                  
                  <?php endforeach; ?>
