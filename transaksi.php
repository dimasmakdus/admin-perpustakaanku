...
<head>
  ...
  <title>Perpustakaan Mahasiswa | Transaksi Peminjaman</title>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="kembali" >Tanggal Kembali</label>
                      <select class="form-control" name="kembali" id="kembali" >
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-success" name="submit">Pinjam Buku</button>
                  </div>
                </div>
                <!-- /.card-body -->
              </form>
